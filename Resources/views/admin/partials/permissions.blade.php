                                ...
                                <?php foreach ($permissionActionGroup as $permissionAction): ?>
                                    <div class="checkbox">
                                        <label for="<?php echo "$subPermissionTitle.$permissionAction" ?>">
                                            ...
                                            <input id="<?php echo "$subPermissionTitle.$permissionAction" ?>" name="permissions[<?php echo "$subPermissionTitle.$permissionAction" ?>]" type="checkbox" class="flat-blue" <?php echo array_get($usersPermissions, "$subPermissionTitle.$permissionAction", false) == true ? 'checked' : '' ?> value="true" /> {{ ucfirst($permissionAction) }}
                                        </label>
                                    </div>
                                <?php endforeach; ?>
                            </div>
